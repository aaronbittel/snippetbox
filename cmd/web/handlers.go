...
import (
	...
	"github.com/aaronbittel/snippetbox/internal/validator"
)
...
func (app *application) snippetCreatePost(w http.ResponseWriter, r *http.Request) {
	...
	form.CheckField(validator.PermittedValue(form.Expires, 1, 7, 365),
		"expires", "This field must eqaul 1, 7 or 365")
...
// INFO: When I want to do automatic form parsing: github.com/go-playground/form/v4@v4
